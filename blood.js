// نغلف الكود بالكامل لضمان تحميل عناصر HTML ومكتبة سوبابيز أولاً
document.addEventListener('DOMContentLoaded', () => {

    // التأكد من أن مكتبة Supabase تم جلبها بنجاح
    if (typeof window.supabase === 'undefined') {
        console.error('مكتبة Supabase لم يتم تحميلها.');
        alert('حدث خطأ في جلب مكتبة قاعدة البيانات، تأكد من اتصال الإنترنت.');
        return;
    }
