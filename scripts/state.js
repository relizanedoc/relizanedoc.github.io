...
export const i18n = {
    en: {
        ...
        personalInfoTitle: 'Doctor Personal Information',
        selectSpecialtyLabel: 'Select a specialty',
        reviewsSummaryTitle: "Reviews Summary",
        backToProfile: "← Back to Profile",
        analyticsTitle: "Clinic Analytics & Performance",
        adminPanelTitle: "Super Admin Panel",
    adminPendingReviews: "Pending Reviews",
    adminManageDoctors: "Manage Doctors",
    loading: "Loading...",
    doctorName: "Doctor Name",
    accountStatus: "Account Status",
    actions: "Actions",
    noPendingReviews: "No pending reviews to moderate.",
totalAppointments: "Total Appointments",
confirmedAppointments: "Confirmed",
pendingAppointments: "Pending",
cancelledAppointments: "Cancelled",
verifiedReviews: "Verified Review(s)",
addYourReviewTitle: "Add Your Review",
whatsYourRating: "What is your rating?",
reviewPlaceholder: "Write your experience with this doctor to help others...",
publishReview: "Publish Review",
mustLoginToReview: "You must login to add a review.",
loadMoreReviewsText: "Load more reviews",
starsText: "Stars",
noReviewsYet: "No reviews yet.",
pendingReview: "Pending",
selectCityLabel: 'In this municipality',
...
chatBookDetailsBtn: 'View Details & Book',
        tabBookDoctor: 'Book a doctor',
tabBookSub: 'Examination or procedure',
tabTelehealth: 'Telehealth',
tabTelehealthSub: 'Call consultation with doctor',
selectSpecialtyLabel: 'Select a specialty',
selectCityLabel: 'In this municipality',
searchByNameLabel: 'Or search by name',
searchBtnText: 'Search',
        ...
        trackAnotherBooking: 'Track Another Booking', heroSubtitle: 'Your all-in-one platform to find doctors and book medical appointments in Relizane.',
        ...
        'الطب الداخلي - Internal Medicine': 'Internal Medicine', 'الطب المخبري (التحاليل) - Laboratory Medicine': 'Laboratory Medicine', 'الطب النفسي - Psychiatry': 'Psychiatry',
      ...
      ar: {
       ...
       changePasswordDesc: 'يرجى إدخال كلمة المرور الجديدة (يجب أن تتكون من 6 أحرف على الأقل).',
        ...
        contactSalesBtn: 'تواصل معنا لتفعيل حسابك',
          personalInfoTitle: 'المعلومات الشخصية للطبيب',
          tabBookDoctor: 'احجز طبيباً',
          reviewsSummaryTitle: "ملخص التقييمات",
          backToProfile: "← العودة لملف الطبيب",
          analyticsTitle: "إحصائيات وأداء العيادة",
          adminPanelTitle: "لوحة الإدارة العليا",
    adminPendingReviews: "التقييمات المعلقة",
    adminManageDoctors: "إدارة الأطباء",
    loading: "جاري التحميل...",
    doctorName: "اسم الطبيب",
    accountStatus: "حالة الحساب",
    actions: "إجراءات",
    noPendingReviews: "لا توجد تقييمات معلقة للمراجعة.",
          completedAppointments: "مكتملة",
totalAppointments: "إجمالي المواعيد",
confirmedAppointments: "مؤكدة",
pendingAppointments: "قيد الانتظار",
cancelledAppointments: "ملغاة",
loadMoreReviewsText: "عرض المزيد من التقييمات",
verifiedReviews: "تقييم معتمد",
addYourReviewTitle: "أضف تقييمك",
starsText: "نجوم",
noReviewsYet: "لا توجد تقييمات حتى الآن.",
whatsYourRating: "ما هو تقييمك؟",
pendingReview: "قيد المراجعة",
reviewPlaceholder: "اكتب تجربتك مع هذا الطبيب لمساعدة الآخرين...",
publishReview: "نشر التقييم",
mustLoginToReview: "يجب تسجيل الدخول لإضافة تقييم.",
tabBookSub: 'كشف أو إجراء طبي',
tabTelehealth: 'استشارة عن بعد',
tabTelehealthSub: 'محادثة هاتفية مع الطبيب',
// إذا لم تضفها سابقاً:
selectSpecialtyLabel: 'اختر اختصاصاً',
selectCityLabel: 'في هذه البلدية',
searchByNameLabel: 'أو ابحث باسم الطبيب',
searchBtnText: 'بحث',
    firstNameAr: 'الاسم (بالعربية) *',
    lastNameAr: 'اللقب (بالعربية) *',
    firstNameEn: 'الاسم (بالإنجليزية)',
    lastNameEn: 'اللقب (بالإنجليزية)',
          selectSpecialtyLabel: 'اختر اختصاصاً',
selectCityLabel: 'في أي بلدية؟',
searchByNameLabel: 'أو ابحث باسم الطبيب',
searchBtnText: 'بحث',
...
fetchBookingsError: 'خطأ في الاتصال: تعذر جلب المواعيد.', bookingNumber: 'رقم الحجز: ', loginDesc: 'أدخل كلمة المرور  ورقم الهاتف المسجل لعرض مواعيدك.', doctorId: 'معرف الطبيب',
        ...
        'الجراحة التجميلية - Plastic Surgery': 'الجراحة التجميلية', 'الجراحة العامة - General Surgery': 'الجراحة العامة', 'الطب الداخلي - Internal Medicine': 'الطب الداخلي', 'الطب المخبري (التحاليل) - Laboratory Medicine': 'الطب المخبري (التحاليل)',
