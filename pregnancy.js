...
const fetalDevelopment = {
    ...
    2: { fruit: "🥚", fruitName: "بويضة", size: "0.1", weight: "0", description: "يستعد الجسم للإباضة. تخرج بويضة ناضجة من المبيض في نهاية هذا الأسبوع" },
    3: { fruit: "✨", fruitName: "خلية مخصبة", size: "0.1", weight: "0", description: "يحدث الإخصاب وتبدأ البويضة المخصبة بالانقسام والتوجه نحو الرحم للانغراس" },
    ...
    37: { fruit: "🍉", fruitName: "بطيخة صغيرة", size: "48.6", weight: "2859", description: "الجنين مكتمل النمو! ينتظر اللحظة المناسبة للولادة" },
    38: { fruit: "🍉", fruitName: "بطيخة متوسطة", size: "49.8", weight: "3100", description: "الجنين جاهز للولادة في أي وقت" },
    39: { fruit: "🍉", fruitName: "بطيخة كبيرة", size: "50.7", weight: "3300", description: "الولادة يمكن أن تحدث في أي لحظة" },
