...
const SUPABASE_ANON_KEY =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imlpcmp0bW9icGhnbWtnd2t3dW1jIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA5NDA2NjYsImV4cCI6MjA5NjUxNjY2Nn0.Yfa0oEwp_id9tHpSb3h0jf__B4drqXsM-TVs4VTTmp4";
const { createClient } = window.supabase;
const supabaseClient = createClient(SUPABASE_URL, SUPABASE_ANON_KEY);

const RECAPTCHA_SITE_KEY = "6Ld2mAEtAAAAADCb15UwZclk7Yubl-Yh6lyFSlLT";
const API_URL =
  "https://script.google.com/macros/s/AKfycbxuQvatnWUMoMMSA6QTsbpxhO6r3Qh54yoj8Zrkor_2Icg3n3AVP7_2ajh0NvEPMlTgRw/exec";
...
// ... [بقية كود i18n كما هو] ...
const i18n = {
  en: {
    memberDashboardTitle: "Member Dashboard",
    trackPhoneLabel: "Phone Number used for booking",
    appName: "Relizane Medical",
    ...
    phone: "Phone Number *",
    phonePlaceholder: "e.g. 0550 123 456",
    exactLocation: "Exact Location / Address *",
    locationPlaceholder: "Street, Building, Floor, Landmark...",
    specialty: "Specialty *",
    specialtyPlaceholder: "e.g. General Practice",
    municipality: "Municipality (Baladiya) *",
    municipalityPlaceholder: "e.g. Relizane",
    extraInfo: "Extra Information",
    extraInfoPlaceholder:
      "Working hours, consultation fees, languages spoken, diplomas...",
    registerBtn: "Register Doctor",
    backToDirectory: "← Back to Directory",
    backToHome: "← Back to Directory",
    bookAppointment: "Book Appointment",
    patientName: "Patient Full Name *",
    patientNamePlaceholder: "Full name",
    patientPhone: "Patient Phone *",
    patientPhonePlaceholder: "Contact number",
    appointmentDate: "Appointment Date *",
    appointmentTime: "Time *",
    confirmBooking: "Confirm Booking",
    confirmDialogTitle: "Confirm Appointment",
    confirmDialogMsg: "Are you sure you want to book this appointment?",
    cancel: "Cancel",
    doctorLogin: "Doctor Login",
    loginDesc:
      "Enter your Doctor ID and registered phone number to view your appointments.",
    patientLabel: "Patient: ",
    statusPending: "Pending",
    statusConfirmed: "Confirmed",
    statusCancelled: "Cancelled",
    bookNewAppointment: "Book New Appointment",
    fetchingBookings: "Fetching your bookings...",
    noUserBookings: "No bookings registered to your account currently.",
    bookFirstAppt: "Book your first appointment",
    fetchBookingsError: "Connection error: Unable to fetch appointments.",
    bookingNumber: "Booking ID: ",
    doctorId: "Doctor ID",
    doctorIdPlaceholder: "e.g. DOC-20240526-143022",
    loginPhone: "Phone Number",
    loginPhonePlaceholder: "Your registered phone",
    ...
    thStatus: "Status",
    thActions: "Actions",
    noAppointmentsMsg: "No appointments found.",
    navHome: "Directory",
    navTrack: "Track Booking",
    navAdd: "Add Doctor",
    navDashboard: "Doctor Login",
    navLogin: "Login",
    chatTitle: "Medical Assistant",
    chatSubtitle: "Available for instant reply",
    chatWelcome:
      'Hello! I am your AI assistant 🩺. How can I help you today? (e.g. "I need an eye doctor in Relizane" or "Find Dr. Amine")',
    chatInputPlaceholder: "Type your question here...",
    chatToggleBtn: "Chat with us",
    chatLoadingDB:
      "Sorry, the doctors database is currently loading. Please try again in a moment.",
    chatNoResults:
      "Sorry, I couldn't find any doctors matching your search. Try typing the name correctly, or mention the specialty and municipality.",
    chatFoundPrefix: "I found ",
    chatFoundSuffix:
      " doctors based on your request. Here are the top 3 results:",
    ...
    loginRequired: "Please login to add a doctor.",
    toastRegisterSuccess: "Doctor registered! ID: ",
    toastRegisterError: "Registration failed: ",
    toastBookingSuccess: "Appointment confirmed! ID: ",
    toastBookingError: "Booking failed: ",
    toastLoginError: "Login failed: ",
    toastLoadError: "Failed to load directory",
    loadingError: "Unable to load doctors.",
    bookBtn: "Book Appointment",
    toastAuthSuccess: "Welcome! ",
    toastAuthError: "Authentication failed: ",
    ...
    heroTitle: "Relizane Medical Directory",
    registeredMember: "Registered Member",
    myRecentBookings: "My Recent Bookings",
    trackAnotherBooking: "Track Another Booking",
    heroSubtitle:
      "Your comprehensive platform to find doctors, clinics, and book medical appointments across all municipalities of Relizane.",
    enableBooking: "Enable Bookings",
    disableBooking: "Disable Bookings",
    bookingsClosed: "Bookings Closed",
    toastToggleSuccess: "Booking status updated",
    toastToggleError: "Failed to update status",
    trackBookingTitle: "Track Booking Status",
    trackBookingDesc:
      "Enter your booking ID to check if the doctor has confirmed it.",
    bookingIdLabel: "Booking ID (APT)",
    trackSearchBtn: "Search Booking",
    workingHoursTitle: "Working Days & Hours Settings",
    workingHoursDesc:
      "Enable your working days and set the start/end time for each day.",
    saveHoursBtnText: "Save Hours",
    scheduleTitle: "Available Schedule",
    fallbackTitle: "Available Working Hours",
    dailyTxt: "Daily:",
    selectDateFirst:
      "Please select an appointment date first to see available times...",
    invalidDate: "Please enter a valid date...",
    selectSpec: "-- Select Specialty --",
    ratingLabel: "What is your rating?",
    reviewPlaceholder: "Write your experience to help others...",
    submitReviewBtn: "Publish Review",
    loginToReviewText: "You must log in to add a review.",
    selectMun: "-- Select Municipality --",
    doctorOff:
    ...
    eveningSession: "Afternoon / Evening",
    sun: "Sunday",
    mon: "Monday",
    tue: "Tuesday",
    wed: "Wednesday",
  ...
  ar: {
    memberDashboardTitle: "لوحة تحكم العضو",
    trackPhoneLabel: "رقم الهاتف المرفق بالحجز",
    appName: "دليل أطباء غليزان",
    findDoctor: "ابحث عن طبيب",
    searchPlaceholder: "🔍 ابحث بالاسم أو الاختصاص أو الموقع...",
    allSpecialties: "جميع الاختصاصات",
    allMunicipalities: "جميع البلديات",
    loadingDoctors: "جاري تحميل قائمة الأطباء...",
    noDoctorsFound: "لا يوجد أطباء مطابقون لبحثك.",
    ...
    phone: "رقم الهاتف *",
    phonePlaceholder: "مثال: 0550 123 456",
    exactLocation: "العنوان الدقيق *",
    locationPlaceholder: "الشارع، المبنى، الطابق، معلم قريب...",
    specialty: "الاختصاص *",
    ...
    chatWelcome:
      'أهلاً بك في دليل أطباء غليزان. أنا مساعدك الآلي🩺. كيف يمكنني مساعدتك اليوم؟ (مثال: "أريد رقم طبيب عيون في غليزان" أو "ابحث عن الدكتور أمين")',
    chatInputPlaceholder: "اكتب سؤالك هنا...",
    chatToggleBtn: "تحدث معنا",
    chatLoadingDB:
      "عذراً، جاري تحميل قاعدة بيانات الأطباء حالياً. يرجى المحاولة بعد لحظات.",
    chatNoResults:
      "عذراً، لم أتمكن من العثور على أطباء يطابقون بحثك. حاول كتابة اسم الطبيب بدقة، أو ذكر الاختصاص والبلدية.",
    ...
    municipalityPlaceholder: "مثال: غليزان",
    extraInfo: "معلومات إضافية",
    extraInfoPlaceholder:
      "أوقات العمل، أجرة الكشف، اللغات المحكية، الشهادات...",
    registerBtn: "تسجيل الطبيب",
    backToDirectory: "← العودة للدليل",
    backToHome: "← العودة للدليل",
    bookAppointment: "حجز موعد",
    patientName: "اسم المريض الكامل *",
    patientNamePlaceholder: "الاسم الكامل",
    patientPhone: "هاتف المريض *",
    patientPhonePlaceholder: "رقم الاتصال",
    appointmentDate: "تاريخ الموعد *",
    appointmentTime: "الوقت *",
    confirmBooking: "تأكيد الحجز",
    confirmDialogTitle: "تأكيد الموعد",
    confirmDialogMsg: "هل أنت متأكد من حجز هذا الموعد؟",
    cancel: "إلغاء",
    ...
    fetchingBookings: "جاري جلب حجوزاتك...",
    noUserBookings: "لا توجد حجوزات مسجلة بحسابك حالياً.",
    bookFirstAppt: "احجز موعدك الأول",
    selectSpec: "-- اختر الاختصاص --",
    selectMun: "-- اختر البلدية --",
    fetchBookingsError: "خطأ في الاتصال: تعذر جلب المواعيد.",
    bookingNumber: "رقم الحجز: ",
    loginDesc: "أدخل معرف الطبيب ورقم الهاتف المسجل لعرض مواعيدك.",
    doctorId: "معرف الطبيب",
    doctorIdPlaceholder: "مثال: DOC-20240526-143022",
    loginPhone: "رقم الهاتف",
    loginPhonePlaceholder: "الهاتف المسجل",
    viewAppointments: "عرض مواعيدي",
    myAppointments: "مواعيدي",
    logout: "تسجيل الخروج",
    thBookingId: "رقم الحجز",
    ...
    thStatus: "الحالة",
    thActions: "الإجراءات",
    noAppointmentsMsg: "لا توجد مواعيد.",
    registeredMember: "عضو مسجل",
    myRecentBookings: "حجوزاتي الأخيرة",
    trackAnotherBooking: "تتبع حجز آخر",
    ratingLabel: "ما هو تقييمك؟",
    reviewPlaceholder: "اكتب تجربتك مع هذا الطبيب لمساعدة الآخرين...",
    submitReviewBtn: "نشر التقييم",
    loginToReviewText: "يجب تسجيل الدخول لإضافة تقييم.",
    navHome: "الدليل",
    navTrack: "تتبع حجزي",
    navAdd: "إضافة طبيب",
    navDashboard: "دخول الأطباء",
    navLogin: "تسجيل الدخول",
    loginTitle: "تسجيل دخول الأعضاء",
    signUpTitle: "إنشاء حساب جديد",
    loginBtn: "دخول",
    signUpBtn: "سجل الآن",
    googleSignIn: "تسجيل الدخول عبر غوغل",
    or: "أو",
    ...
    loginRequired: "يجب تسجيل الدخول لإضافة طبيب.",
    toastRegisterSuccess: "تم تسجيل الطبيب! المعرف: ",
    toastRegisterError: "فشل التسجيل: ",
    toastBookingSuccess: "تم تأكيد الموعد! رقم الحجز: ",
    toastBookingError: "فشل الحجز: ",
    toastLoginError: "فشل تسجيل الدخول: ",
    toastLoadError: "فشل تحميل الدليل",
    loadingError: "تعذر تحميل قائمة الأطباء.",
    bookBtn: "حجز موعد",
    toastAuthSuccess: "أهلاً! ",
    toastAuthError: "فشل المصادقة: ",
    ...
    heroSubtitle:
      "منصتك الشاملة للبحث عن الأطباء، العيادات، وحجز المواعيد الطبية في كافة بلديات ولاية غليزان.",
    enableBooking: "تفعيل الحجوزات",
    disableBooking: "إيقاف الحجوزات",
    bookingsClosed: "الحجوزات مغلقة حالياً",
    toastToggleSuccess: "تم تحديث حالة الحجز",
    toastToggleError: "فشل تحديث الحالة",
    trackBookingTitle: "تتبع حالة الحجز",
    trackBookingDesc: "أدخل رقم الحجز الذي حصلت عليه للتحقق من تأكيد الطبيب.",
    bookingIdLabel: "رقم الحجز (APT)",
    trackSearchBtn: "بحث عن الحجز",
    workingHoursTitle: "إعدادات أيام وأوقات العمل",
    workingHoursDesc:
      "قم بتفعيل الأيام التي تعمل فيها وحدد وقت البداية والنهاية لكل يوم.",
    saveHoursBtnText: "حفظ الأوقات",
    scheduleTitle: "جدول العمل المتاح للطبيب",
    fallbackTitle: "أوقات العمل المتاحة",
    dailyTxt: "يومياً:",
    selectDateFirst: "يرجى تحديد تاريخ الموعد أولاً لعرض الأوقات المتاحة...",
    invalidDate: "يرجى إدخال تاريخ صحيح...",
    doctorOff: "الطبيب لا يعمل في هذا اليوم، يرجى اختيار تاريخ آخر.",
    noSlots: "عذراً، لا توجد فترات زمنية كافية للحجز في هذا اليوم.",
    morningSession: "الفترة الصباحية",
    eveningSession: "الفترة المسائية",
    sun: "الأحد",
    mon: "الإثنين",
    tue: "الثلاثاء",
    wed: "الأربعاء",
...
function isAccountLocked() {
  ...
  if (Date.now() < parseInt(lockoutTime, 10)) {
    const remaining = Math.ceil(
      (parseInt(lockoutTime, 10) - Date.now()) / 60000,
    );
    showToast(
      (currentLang === "ar"
        ? "الحساب مقفل. حاول بعد "
        : "Account locked. Try again in ") +
        remaining +
        (currentLang === "ar" ? " دقيقة." : " minutes."),
      "error",
    );
    return true;
  }
...
function recordFailedAttempt() {
  ...
  if (attempts >= MAX_LOGIN_ATTEMPTS) {
    ...
    showToast(
      currentLang === "ar"
        ? "محاولات كثيرة. الحساب مقفل 30 دقيقة."
...
async function syncUserWithBackend(firebaseUser) {
  ...
  try {
    ...
    const result = await apiPost("authFirebase", {
      idToken,
...
function updateUserUI(user) {
  ...
  if (user) {
    ...
    if (nameDisplay) {
      ...
      nameDisplay.title =
        currentLang === "ar" ? "الذهاب للوحة التحكم" : "Go to Dashboard";
...
async function apiPost(action, data = {}) {
  if (
    ...
    try {
      data.recaptchaToken = await grecaptcha.execute(RECAPTCHA_SITE_KEY, {
        action,
      });
    } catch (e) {}
  }
  ...
  if (fbUser && action !== "authFirebase")
    data.idToken = await fbUser.getIdToken();
    ...
    if (isSignUp) {
      ...
      if (data.user) {
        ...
        if (loginError && loginError.message.includes("Email not confirmed")) {
          ...
          showToast(
            "تم إنشاء الحساب بنجاح! " + t("toastAuthSuccess") + name,
            "success",
          );
      ...
      resetLoginAttempts();
      showToast(
        t("toastAuthSuccess") + (data.user.user_metadata?.name || email),
        "success",
      );
      setTimeout(() => router("user-dashboard"), 500);
    }
...
function toggleAuthMode() {
  isSignUp = !isSignUp;
  document
    .getElementById("nameFieldGroup")
    .classList.toggle("hidden", !isSignUp);
  document.getElementById("authFormTitle").textContent = t(
    isSignUp ? "signUpTitle" : "loginTitle",
  );
  document.getElementById("authSubmitBtn").querySelector("span").textContent =
    t(isSignUp ? "signUpBtn" : "loginBtn");
  document.getElementById("authToggleText").textContent = t(
    isSignUp ? "hasAccount" : "noAccount",
  );
}
...
function openScheduleModal(doctorName, scheduleHtml) {
  ...
  overlay.style.cssText =
    "position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6); backdrop-filter: blur(4px); z-index: 99999; display: flex; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.3s ease; padding: 1rem;";
  const modal = document.createElement("div");
  modal.className = "card";
  modal.style.cssText =
    "width: 100%; max-width: 380px; transform: translateY(30px); transition: transform 0.3s ease; position: relative; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1); text-align: center; border-top: 4px solid var(--primary);";
  const titleText =
    currentLang === "ar" ? "الجدول الأسبوعي" : "Weekly Schedule";
...
function renderDoctors(doctors) {
  ...
  if (!doctors || doctors.length === 0) {
    container.innerHTML =
      '<div class="empty-state"><div class="empty-state-icon" style="opacity: 1; color: var(--text-secondary); margin-bottom: 1rem; display: flex; justify-content: center;"><svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></div><div>' +
      t("noDoctorsFound") +
      "</div></div>";
    return;
  }
  doctors.forEach((doc) => {
    ...
    actionBtn.className =
      "btn " +
      (isBookingEnabled ? "btn-primary" : "btn-secondary") +
      " btn-block";
    actionBtn.style.cssText =
      "margin-top: 1rem; padding: 0.6rem; border-radius: 8px; transition: all 0.2s;";
...
function openDoctorProfileModal(doc, doctorName) {
  ...
  if (doc.working_days && Object.keys(doc.working_days).length > 0) {
    try {
      const wd =
        typeof doc.working_days === "string"
          ? JSON.parse(doc.working_days)
          : doc.working_days;
      const daysNames =
        currentLang === "ar"
          ? [
...
function updateSEOMetaTags(doc) {
  ...
  const pageTitle =
    currentLang === "ar"
      ? `د. ${doc.first_name} ${doc.last_name} | ${doc.specialty} في ${doc.municipality}`
      : `Dr. ${doc.first_name} ${doc.last_name} | ${doc.specialty} in ${doc.municipality}`;
  const pageDesc =
    currentLang === "ar"
      ? `احجز موعدك مع د. ${doc.first_name} ${doc.last_name}، أخصائي ${doc.specialty} في ${doc.municipality}، ولاية غليزان. العنوان: ${doc.exact_location}`
      : `Book an appointment with Dr. ${doc.first_name} ${doc.last_name}, ${doc.specialty} in ${doc.municipality}, Relizane.`;
    ...
    if (targetDoc) {
      ...
      if (!backBtn) {
        ...
        backBtn.onclick = () => {
          ...
          document.title =
            currentLang === "ar"
              ? "دليل أطباء ولاية غليزان"
              : "Relizane Medical Directory";
          renderDoctors(allDoctors);
          backBtn.remove();
        };
        document
          .getElementById("doctorsList")
          .insertAdjacentElement("beforebegin", backBtn);
      }
      return;
    }
  }
...
function populateFilters() {
  ...
  const muns = [
    ...new Set(allDoctors.map((d) => d.municipality).filter(Boolean)),
  ].sort();
  ...
  if (window.tsSpecialtyFilter) {
    ...
    Array.from(specSel.options).forEach((opt) =>
      window.tsSpecialtyFilter.addOption({ value: opt.value, text: opt.text }),
    );
    window.tsSpecialtyFilter.setValue(prevSpec);
  }
  if (window.tsMunicipalityFilter) {
    window.tsMunicipalityFilter.clearOptions();
    Array.from(munSel.options).forEach((opt) =>
      window.tsMunicipalityFilter.addOption({
        value: opt.value,
        text: opt.text,
      }),
    );
...
function filterDoctors() {
  ...
  const filtered = allDoctors.filter((doc) => {
    const text =
      `${doc.first_name || ""} ${doc.last_name || ""} ${doc.specialty || ""} ${doc.municipality || ""} ${doc.exact_location || ""}`.toLowerCase();
    return (
      (!search || text.includes(search)) &&
      (!spec || doc.specialty === spec) &&
      (!mun || doc.municipality === mun)
    );
  });
...
// ✅ دالة توليد الأوقات (مرة واحدة فقط)
...
function openBooking(doctorId) {
  ...
  if (!currentDoctor) {
    ...
    showToast(
      currentLang === "ar" ? "الطبيب غير موجود" : "Doctor not found",
      "error",
    );
    return;
  }
  ...
  if (currentDoctor.working_days) {
    try {
      wd =
        typeof currentDoctor.working_days === "string"
  ...
  if (scheduleHtml === "") {
    const st = currentDoctor.working_days
      ? "08:00"
      : currentDoctor.StartTime
        ? currentDoctor.StartTime.substring(0, 5)
        : "08:00";
    const et = currentDoctor.working_days
      ? "16:00"
      : currentDoctor.EndTime
        ? currentDoctor.EndTime.substring(0, 5)
        : "16:00";
    scheduleHtml = `
            <div style="margin-top: 1.25rem; padding: 1rem; background: var(--bg); border-radius: var(--radius); border: 1px solid var(--border);">
  ...
  dateInput.value = "";
  if (timeContainer)
    timeContainer.innerHTML = `<div class="text-sm text-gray" style="grid-column: 1 / -1;" data-i18n="selectDateFirst">${t("selectDateFirst")}</div>`;
...
async function submitBooking() {
  ...
  if (
    ...
    showToast(
      currentLang === "ar" ? "يرجى ملء جميع الحقول" : "Please fill all fields",
      "error",
    );
    setLoading(btn, false);
    return;
  ...
  try {
    ...
    if (timeContainer) {
      timeContainer.innerHTML =
        '<div class="text-sm text-gray" style="grid-column: 1 / -1;">يرجى تحديد تاريخ الموعد أولاً لعرض الأوقات المتاحة...</div>';
    }
...
function renderDashboardUI(data, doctorId) {
  ...
  document.getElementById("dashboardSubtitle").textContent = data.doctorName
    ? currentLang === "ar"
      ? `د. ${data.doctorName}`
      : `Dr. ${data.doctorName}`
    : doctorId;
  ...
  let savedDays = {};
  try {
    savedDays = JSON.parse(data.workingDays || "{}");
  } catch (e) {}
  const container = document.getElementById("daysListContainer");
  container.innerHTML = "";
  for (let i = 0; i <= 6; i++) {
    const dayData = savedDays[i.toString()] || {
      active: true,
      start: "08:00",
      end: "16:00",
    };
    ...
    row.style.cssText =
      "display: flex; align-items: center; gap: 1rem; flex-wrap: wrap; background: var(--bg); padding: 0.75rem; border-radius: var(--radius); border: 1px solid var(--border);";
    row.innerHTML = `
  ...
  tbody.innerHTML = appointments
    .map((a) => {
      ...
      let statusStyle =
        "background: #f1f5f9; color: #64748b; border: 0.5px solid #cbd5e1;";
      if (statusTextDb === "confirmed") {
        statusStyle =
          "background: #ecfdf5; color: #10b981; border: 0.5px solid #a7f3d0;";
...
async function fillDashboardData(doctor) {
  try {
    ...
    const dashboardData = {
      ...
      workingDays:
        typeof fullDoctor.working_days === "string"
          ? fullDoctor.working_days
          : JSON.stringify(fullDoctor.working_days || {}),
...
async function handleDashboardLogin(e) {
  ...
  if (!phone || !password) {
    showToast(
      currentLang === "ar"
        ? "يرجى إدخال الهاتف وكلمة المرور"
  ...
  try {
    ...
    if (!doctor.is_active) {
      throw new Error(
        currentLang === "ar"
          ? "حسابك غير مفعّل بعد. يرجى التواصل مع الإدارة."
    ...
    showToast(
      currentLang === "ar"
        ? "أهلاً د. " + doctor.first_name
        : "Welcome Dr. " + doctor.first_name,
      "success",
    );
  } catch (err) {
    recordFailedAttempt();
...
window.changeBookingStatus = async function (bookingId, newStatus) {
  ...
  if (
    !confirm(
      currentLang === "ar"
        ? `تأكيد تغيير الحالة إلى: ${statusText}؟`
  ...
  try {
    ...
    if (error) throw error;
    showToast(
      currentLang === "ar" ? "تم التحديث بنجاح" : "Updated successfully",
      "success",
    );
...
// ✅ تفعيل/إيقاف الحجوزات (مرة واحدة فقط)
...
function setLang(lang) {
  ...
  document.querySelectorAll("[data-nav]").forEach((btn) => {
    ...
    if (navMap[view] && i18n[lang][navMap[view]])
      btn.textContent = i18n[lang][navMap[view]];
  });
  const specSel = document.getElementById("specialtyFilter");
  if (specSel && specSel.options[0])
    specSel.options[0].text = t("allSpecialties");
  const munSel = document.getElementById("municipalityFilter");
  if (munSel && munSel.options[0])
    munSel.options[0].text = t("allMunicipalities");
  const addSpecSel = document.querySelector('select[name="Specialty"]');
  if (addSpecSel && addSpecSel.options[0])
    addSpecSel.options[0].text = t("selectSpec");
  const addMunSel = document.querySelector('select[name="Municipality"]');
  if (addMunSel && addMunSel.options[0])
    addMunSel.options[0].text = t("selectMun");
  updateAuthToggle();
  updateUserUI();
  ...
  if (
    typeof globalDashboardData !== "undefined" &&
    globalDashboardData !== null &&
    typeof globalDashboardDoctorId !== "undefined" &&
  ...
  setTimeout(() => {
    if (window.tsAddSpecialty && addSpecSel) {
      ...
      Array.from(addSpecSel.options).forEach((opt) =>
        window.tsAddSpecialty.addOption({ value: opt.value, text: opt.text }),
      );
    ...
    if (window.tsAddMunicipality && addMunSel) {
      ...
      Array.from(addMunSel.options).forEach((opt) =>
        window.tsAddMunicipality.addOption({
          value: opt.value,
          text: opt.text,
        }),
      );
...
document.querySelectorAll("#starRatingInput .star").forEach((star) => {
  ...
  star.addEventListener("mouseout", function () {
    document.querySelectorAll("#starRatingInput .star").forEach((s) => {
      s.style.color =
        parseInt(s.getAttribute("data-val")) <= currentReviewRating
          ? "#f59e0b"
          : "var(--border)";
    });
  });
...
window.openReviewsModal = async function (doctorId, doctorName) {
  document.getElementById("reviewsDoctorName").textContent =
    (currentLang === "ar" ? "تقييمات د. " : "Reviews for Dr. ") + doctorName;
...
window.deleteReview = async function (reviewId, doctorId) {
  if (
    !confirm(
      currentLang === "ar"
        ? "هل أنت متأكد أنك تريد حذف تقييمك بشكل نهائي؟"
    ...
    try {
      ...
      if (error) {
        ...
        document
          ...
          .forEach((s) => (s.style.color = "var(--border)"));
        loadReviews(doctorId);
      }
    } catch (err) {
      ...
      setLoading(
        btn,
        false,
        currentLang === "ar" ? "نشر التقييم" : "Submit Review",
      );
    }
  }
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.tsMunicipalityFilter = new TomSelect(
    "#municipalityFilter",
    tsSettings,
  );
  ...
  window.tsAddMunicipality = new TomSelect(
  ...
  if (trackForm) {
    trackForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        showToast(
          currentLang === "ar"
            ? "لم يتم العثور على الحجز، تأكد من الرقم والهاتف"
            : "Booking not found. Check ID and phone.",
          "error",
        );
      } finally {
        setLoading(
          btn,
          false,
          currentLang === "ar" ? "بحث عن الحجز" : "Search Booking",
        );
      }
    });
  }
  ...
  async function handleDateSelection(selectedDateStr, workingDays) {
    console.log("🔍 handleDateSelection called with:", {
      selectedDateStr,
      workingDays,
    });
    ...
    try {
      ...
      showToast(
        currentLang === "ar"
          ? "خطأ في جلب الأوقات: " + err.message
  ...
  function displayTimeSlots(container, slots, timeInput) {
    ...
    morningDiv.style.cssText =
      "grid-column: 1 / -1; margin-bottom: 1rem; border: 1px solid var(--border); border-radius: var(--radius); padding: 1rem; background: var(--surface);";
    ...
    eveningDiv.style.cssText =
      "grid-column: 1 / -1; margin-bottom: 0.5rem; border: 1px solid var(--border); border-radius: var(--radius); padding: 1rem; background: var(--surface);";
  ...
  async function loadDoctorAppointments(doctorId) {
    ...
    const empty = document.getElementById("noAppointments");
    container.innerHTML =
      '<div style="text-align:center; padding: 1rem;">جاري التحميل...</div>';
    empty.classList.add("hidden");
    try {
      ...
      container.innerHTML =
        '<div style="text-align:center; color: var(--danger); padding: 1rem;">خطأ في التحميل</div>';
    }
  }
  ...
  window.saveWorkingHours = async function () {
    ...
    try {
      ...
      setLoading(
        btn,
        false,
        currentLang === "ar" ? "حفظ الأوقات" : "Save Hours",
      );
    }
  };
  ...
  // ========================================================================
  window.sendBookingEmail = function (
    recipientEmail,
    doctorName,
    appointmentDate,
    status,
    ...
    var containerStyle =
      "font-family: Arial, sans-serif; direction: rtl; text-align: right; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 10px; overflow: hidden;";
    var headerStyle =
      "background-color: " +
      primaryColor +
      "; color: white; padding: 20px; text-align: center; font-size: 1.25rem; font-weight: bold;";
    var bodyStyle = "padding: 20px; color: #0f172a; line-height: 1.6;";
    var footerStyle =
      "background-color: #f8fafc; padding: 15px; text-align: center; color: #64748b; font-size: 0.85rem; border-top: 1px solid #e2e8f0;";
  ...
  const processUserMessage = (rawMsg) => {
    ...
    matchedDoctors = allDoctors.filter((doc) => {
      ...
      const isNameMatch = cleanMsg
        .split(" ")
        .some(
          (word) =>
            word.length > 2 &&
            (docNameAr.includes(word) || docNameEn.includes(word)),
        );
      const isSpecMatch = detectedSpecialty
        ? doc.specialty === detectedSpecialty
        : true;
      const isMunMatch = detectedMunicipality
        ? doc.municipality === detectedMunicipality
        : true;
      if (isNameMatch && !detectedSpecialty && !detectedMunicipality)
        return true;
      if (
        (detectedSpecialty || detectedMunicipality) &&
        isSpecMatch &&
        isMunMatch
      )
        return true;
    ...
    if (matchedDoctors.length > 3) {
      return (
        `${t("chatFoundPrefix")} ${matchedDoctors.length} ${t("chatFoundSuffix")}` +
        generateCardsHtml(
          matchedDoctors.slice(0, 3),
          isAskingForPhone,
          isAskingForLocation,
        )
      );
