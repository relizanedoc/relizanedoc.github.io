...
@@ -55,253 +46,332 @@ supabaseClient.auth.onAuthStateChange((event, session) => {
  }
});
...
const i18n = {
  en: {
    ...
    cancel: 'Cancel', doctorLogin: 'Doctor Login', loginDesc: 'Enter your phone number and password to view your appointments.',
    ...
    loginPhone: 'Phone Number', loginPhonePlaceholder: 'Your registered phone', loginPassword: 'Password *',
    viewAppointments: 'View My Appointments', myAppointments: 'My Appointments', logout: 'Logout',
    noAppointmentsMsg: 'No appointments found.', navHome: 'Directory', navTrack: 'Track Booking', navAdd: 'Add Doctor',
    navDashboard: 'Doctor Login', navLogin: 'Login',
    chatTitle: 'Medical Assistant', chatSubtitle: 'Available for instant reply',
    chatWelcome: 'Hello! I am your AI assistant 🩺. How can I help you today?',
    chatInputPlaceholder: 'Type your question here...', chatToggleBtn: 'Chat with us',
    chatLoadingDB: 'Sorry, the doctors database is currently loading.',
    chatNoResults: 'Sorry, I couldn\'t find any doctors matching your search.',
    chatFoundPrefix: 'I found ', chatFoundSuffix: ' doctors based on your request.',
    chatExactResults: 'Here are the results matching your question:',
    chatDoctorLabel: 'Doctor: ', chatSpecLabel: 'Specialty: ', chatPhoneLabel: 'Phone: ',
    chatMunLabel: 'Municipality: ', chatAddressLabel: 'Address: ', chatBookDetailsBtn: 'View Details & Book',
    loginTitle: 'Member Login', signUpTitle: 'Create Account', loginBtn: 'Login', signUpBtn: 'Sign Up',
    googleSignIn: 'Sign in with Google', or: 'or', fullName: 'Full Name', fullNamePlaceholder: 'Your full name',
    email: 'Email *', emailPlaceholder: 'your@email.com', password: 'Password *', passwordPlaceholder: '••••••••',
    noAccount: "Don't have an account? Sign up", hasAccount: 'Already have an account? Login',
    loginRequired: 'Please login to add a doctor.', toastRegisterSuccess: 'Doctor registered! ID: ',
    toastRegisterError: 'Registration failed: ', toastBookingSuccess: 'Appointment confirmed! ID: ',
    toastBookingError: 'Booking failed: ', toastLoginError: 'Login failed: ', toastLoadError: 'Failed to load directory',
    loadingError: 'Unable to load doctors.', bookBtn: 'Book Appointment', toastAuthSuccess: 'Welcome! ',
    toastAuthError: 'Authentication failed: ', toastLogout: 'Logged out',
    weakPassword: 'Password must be at least 6 characters', invalidEmail: 'Invalid email address',
    userNotFound: 'No account found with this email', wrongPassword: 'Incorrect password',
    emailInUse: 'This email is already registered',
    footerRights: '© 2026 Relizane Medical Directory. All rights reserved.',
    privacyPolicy: 'Privacy Policy', contactUs: 'Contact Us',
    heroTitle: 'Relizane Medical Directory', registeredMember: 'Registered Member',
    myRecentBookings: 'My Recent Bookings', trackAnotherBooking: 'Track Another Booking',
    heroSubtitle: 'Your comprehensive platform to find doctors, clinics, and book medical appointments.',
    enableBooking: 'Enable Bookings', disableBooking: 'Disable Bookings', bookingsClosed: 'Bookings Closed',
    toastToggleSuccess: 'Booking status updated', toastToggleError: 'Failed to update status',
    trackBookingTitle: 'Track Booking Status', trackBookingDesc: 'Enter your booking ID to check status.',
    bookingIdLabel: 'Booking ID', trackSearchBtn: 'Search Booking',
    workingHoursTitle: 'Working Days & Hours Settings',
    workingHoursDesc: 'Enable your working days and set the start/end time for each day.',
    saveHoursBtnText: 'Save Hours', scheduleTitle: 'Available Schedule',
    fallbackTitle: 'Available Working Hours', dailyTxt: 'Daily:',
    selectDateFirst: 'Please select an appointment date first to see available times...',
    invalidDate: 'Please enter a valid date...', selectSpec: '-- Select Specialty --',
    ratingLabel: 'What is your rating?', reviewPlaceholder: 'Write your experience...',
    submitReviewBtn: 'Publish Review', loginToReviewText: 'You must log in to add a review.',
    selectMun: '-- Select Municipality --', doctorOff: 'Doctor is not available on this day.',
    noSlots: 'Sorry, no available time slots on this day.',
    morningSession: 'Morning Session', eveningSession: 'Afternoon / Evening',
    sun: 'Sunday', mon: 'Monday', tue: 'Tuesday', wed: 'Wednesday', thu: 'Thursday', fri: 'Friday', sat: 'Saturday',
    'الأرطوفونيا (تقويم النطق) - Speech Therapy': 'Speech Therapy',
    'الأشعة - Radiology': 'Radiology', 'الأمراض الجلدية - Dermatology': 'Dermatology',
    'الأمراض الصدرية - Pulmonology': 'Pulmonology', 'الأمراض المعدية - Infectious Disease': 'Infectious Disease',
    'الأنف والأذن والحنجرة - ENT (Otolaryngology)': 'ENT (Otolaryngology)',
    'التخدير - Anesthesiology': 'Anesthesiology', 'التغذية العلاجية - Clinical Nutrition': 'Clinical Nutrition',
    'الجراحة التجميلية - Plastic Surgery': 'Plastic Surgery', 'الجراحة العامة - General Surgery': 'General Surgery',
    'الطب الباطني - Internal Medicine': 'Internal Medicine',
    'الطب المخبري (التحاليل) - Laboratory Medicine': 'Laboratory Medicine',
    'الطب النفسي - Psychiatry': 'Psychiatry',
    'العلاج الطبيعي وإعادة التأهيل - Physiotherapy & Rehabilitation': 'Physiotherapy & Rehabilitation',
    'الغدد الصماء والسكري - Endocrinology': 'Endocrinology',
    'أمراض الجهاز الهضمي - Gastroenterology': 'Gastroenterology', 'أمراض الدم - Hematology': 'Hematology',
    'أمراض الروماتيزم والمفاصل - Rheumatology': 'Rheumatology', 'أمراض القلب - Cardiology': 'Cardiology',
    'أمراض الكلى - Nephrology': 'Nephrology',
    'أمراض النساء والتوليد - Gynecology & Obstetrics': 'Gynecology & Obstetrics',
    'جراحة الأوعية الدموية - Vascular Surgery': 'Vascular Surgery',
    'جراحة العظام - Orthopedics': 'Orthopedics',
    'جراحة القلب والصدر - Cardiothoracic Surgery': 'Cardiothoracic Surgery',
    'جراحة المخ والأعصاب - Neurosurgery': 'Neurosurgery',
    'جراحة المسالك البولية - Urology': 'Urology', 'طب الأعصاب - Neurology': 'Neurology',
    'طب الأسرة - Family Medicine': 'Family Medicine', 'طب الأسنان - Dentistry': 'Dentistry',
    'طب الأطفال - Pediatrics': 'Pediatrics', 'طب الأورام - Oncology': 'Oncology',
    'طب الحساسية والمناعة - Allergy & Immunology': 'Allergy & Immunology',
    'طب الشيخوخة - Geriatrics': 'Geriatrics', 'طب الطوارئ - Emergency Medicine': 'Emergency Medicine',
    'طب العيون - Ophthalmology': 'Ophthalmology', 'طب عام - General Medicine': 'General Medicine',
    'علم الوراثة الطبية - Medical Genetics': 'Medical Genetics',
    'أولاد سيدي الميهوب': 'Ouled Sidi Mihoub', 'أولاد يعيش': 'Ouled Yaich', 'الحاسي': 'El Hassi',
    'الحمادنة': 'El Hamadna', 'القطار': 'El Guettar', 'القلعة': 'El Kalaa', 'المطمر': 'El Matmar',
    'المرجة': 'El Merdja', 'الولجة': 'El Oueldja', 'بن داود': 'Bendaoud',
    'بني درقون': 'Beni Dergoun', 'بني زنطيس': 'Beni Zentis', 'بلعسل بوزقزة': 'Belassel Bouzegza',
    'جديوية': 'Djidiouia', 'حد الشكالة': 'Had Echkalla', 'حمري': 'Hamri',
    'دار بن عبد الله': 'Dar Benabdellah', 'رمكة': 'Ramka', 'زمورة': 'Zemmoura',
    'سوق الحد': 'Souk El Had', 'سيدي امحمد بن علي': 'Sidi Mhamed Ben Ali',
    'سيدي امحمد بن عودة': 'Sidi Mhamed Benaouda', 'سيدي خطاب': 'Sidi Khettab',
    'سيدي سعادة': 'Sidi Saada', 'سيدي لزرق': 'Sidi Lazreg', 'عين الرحمة': 'Ain Rahma',
    'عين طارق': 'Ain Tarek', 'عمي موسى': 'Ammi Moussa', 'غليزان': 'Relizane',
    'لحلاف': 'Lahlef', 'مازونة': 'Mazouna', 'مديونة': 'Mediouna', 'منداس': 'Mendes',
    'وادي الجمعة': 'Oued El Djemaa', 'وادي السلام': 'Oued Essalem', 'وادي رهيو': 'Oued Rhiou',
    'واريزان': 'Ouarizane', 'يلل': 'Yellel'
  },
  ar: {
    memberDashboardTitle: 'لوحة تحكم العضو', trackPhoneLabel: 'رقم الهاتف المرفق بالحجز',
    appName: 'دليل أطباء غليزان', findDoctor: 'ابحث عن طبيب',
    searchPlaceholder: '🔍 ابحث بالاسم أو الاختصاص أو الموقع...',
    allSpecialties: 'جميع الاختصاصات', allMunicipalities: 'جميع البلديات',
    loadingDoctors: 'جاري تحميل قائمة الأطباء...', noDoctorsFound: 'لا يوجد أطباء مطابقون لبحثك.',
    registerDoctor: 'تسجيل طبيب جديد', firstName: 'الاسم *', firstNamePlaceholder: 'مثال: أمين',
    lastName: 'اللقب *', lastNamePlaceholder: 'مثال: بن علي', phone: 'رقم الهاتف *',
    phonePlaceholder: 'مثال: 0550 123 456', exactLocation: 'العنوان الدقيق *',
    locationPlaceholder: 'الشارع، المبنى، الطابق، معلم قريب...', specialty: 'الاختصاص *',
    specialtyPlaceholder: 'مثال: الطب العام', municipality: 'البلدية *',
    municipalityPlaceholder: 'مثال: غليزان', extraInfo: 'معلومات إضافية',
    extraInfoPlaceholder: 'أوقات العمل، أجرة الكشف، اللغات المحكية، الشهادات...',
    registerBtn: 'تسجيل الطبيب', backToDirectory: '← العودة للدليل', backToHome: '← العودة للدليل',
    bookAppointment: 'حجز موعد', patientName: 'اسم المريض الكامل *', patientNamePlaceholder: 'الاسم الكامل',
    patientPhone: 'هاتف المريض *', patientPhonePlaceholder: 'رقم الاتصال',
    appointmentDate: 'تاريخ الموعد *', appointmentTime: 'الوقت *', confirmBooking: 'تأكيد الحجز',
    confirmDialogTitle: 'تأكيد الموعد', confirmDialogMsg: 'هل أنت متأكد من حجز هذا الموعد؟',
    cancel: 'إلغاء', doctorLogin: 'تسجيل دخول الطبيب',
    loginDesc: 'أدخل رقم هاتفك وكلمة المرور لعرض مواعيدك.',
    patientLabel: 'المريض: ', statusPending: 'قيد الانتظار', statusConfirmed: 'مؤكد',
    statusCancelled: 'ملغى', bookNewAppointment: 'حجز موعد جديد',
    fetchingBookings: 'جاري جلب حجوزاتك...', noUserBookings: 'لا توجد حجوزات مسجلة بحسابك حالياً.',
    bookFirstAppt: 'احجز موعدك الأول', fetchBookingsError: 'خطأ في الاتصال: تعذر جلب المواعيد.',
    bookingNumber: 'رقم الحجز: ', loginPhone: 'رقم الهاتف', loginPhonePlaceholder: 'الهاتف المسجل',
    loginPassword: 'كلمة المرور *', viewAppointments: 'عرض مواعيدي', myAppointments: 'مواعيدي',
    logout: 'تسجيل الخروج', noAppointmentsMsg: 'لا توجد مواعيد.',
    registeredMember: 'عضو مسجل', myRecentBookings: 'حجوزاتي الأخيرة',
    trackAnotherBooking: 'تتبع حجز آخر', ratingLabel: 'ما هو تقييمك؟',
    reviewPlaceholder: 'اكتب تجربتك مع هذا الطبيب لمساعدة الآخرين...',
    submitReviewBtn: 'نشر التقييم', loginToReviewText: 'يجب تسجيل الدخول لإضافة تقييم.',
    navHome: 'الدليل', navTrack: 'تتبع حجزي', navAdd: 'إضافة طبيب',
    navDashboard: 'دخول الأطباء', navLogin: 'تسجيل الدخول',
    loginTitle: 'تسجيل دخول الأعضاء', signUpTitle: 'إنشاء حساب جديد', loginBtn: 'دخول',
    signUpBtn: 'سجل الآن', googleSignIn: 'تسجيل الدخول عبر غوغل', or: 'أو',
    fullName: 'الاسم الكامل', fullNamePlaceholder: 'اسمك الكامل', email: 'البريد الإلكتروني *',
    emailPlaceholder: 'your@email.com', password: 'كلمة المرور *', passwordPlaceholder: '••••••••',
    noAccount: 'ليس لديك حساب؟ سجل الآن', hasAccount: 'لديك حساب بالفعل؟ سجل الدخول',
    loginRequired: 'يجب تسجيل الدخول لإضافة طبيب.', toastRegisterSuccess: 'تم تسجيل الطبيب! المعرف: ',
    toastRegisterError: 'فشل التسجيل: ', toastBookingSuccess: 'تم تأكيد الموعد! رقم الحجز: ',
    toastBookingError: 'فشل الحجز: ', toastLoginError: 'فشل تسجيل الدخول: ',
    toastLoadError: 'فشل تحميل الدليل', loadingError: 'تعذر تحميل قائمة الأطباء.',
    bookBtn: 'حجز موعد', toastAuthSuccess: 'أهلاً! ', toastAuthError: 'فشل المصادقة: ',
    toastLogout: 'تم تسجيل الخروج', weakPassword: 'كلمة المرور يجب أن تكون 6 أحرف على الأقل',
    invalidEmail: 'بريد إلكتروني غير صالح', userNotFound: 'لا يوجد حساب بهذا البريد',
    wrongPassword: 'كلمة المرور غير صحيحة', emailInUse: 'هذا البريد مسجل بالفعل',
    footerRights: '© 2026 دليل أطباء غليزان. جميع الحقوق محفوظة.',
    privacyPolicy: 'سياسة الخصوصية', contactUs: 'اتصل بنا',
    heroTitle: 'دليل أطباء ولاية غليزان',
    heroSubtitle: 'منصتك الشاملة للبحث عن الأطباء، العيادات، وحجز المواعيد الطبية في كافة بلديات ولاية غليزان.',
    enableBooking: 'تفعيل الحجوزات', disableBooking: 'إيقاف الحجوزات',
    bookingsClosed: 'الحجوزات مغلقة حالياً', toastToggleSuccess: 'تم تحديث حالة الحجز',
    toastToggleError: 'فشل تحديث الحالة', trackBookingTitle: 'تتبع حالة الحجز',
    trackBookingDesc: 'أدخل رقم الحجز الذي حصلت عليه للتحقق من تأكيد الطبيب.',
    bookingIdLabel: 'رقم الحجز (APT)', trackSearchBtn: 'بحث عن الحجز',
    workingHoursTitle: 'إعدادات أيام وأوقات العمل',
    workingHoursDesc: 'قم بتفعيل الأيام التي تعمل فيها وحدد وقت البداية والنهاية لكل يوم.',
    saveHoursBtnText: 'حفظ الأوقات', scheduleTitle: 'جدول العمل المتاح للطبيب',
    fallbackTitle: 'أوقات العمل المتاحة', dailyTxt: 'يومياً:',
    selectDateFirst: 'يرجى تحديد تاريخ الموعد أولاً لعرض الأوقات المتاحة...',
    invalidDate: 'يرجى إدخال تاريخ صحيح...', selectSpec: '-- اختر الاختصاص --',
    selectMun: '-- اختر البلدية --', doctorOff: 'الطبيب لا يعمل في هذا اليوم، يرجى اختيار تاريخ آخر.',
    noSlots: 'عذراً، لا توجد فترات زمنية كافية للحجز في هذا اليوم.',
    morningSession: 'الفترة الصباحية', eveningSession: 'الفترة المسائية',
    sun: 'الأحد', mon: 'الإثنين', tue: 'الثلاثاء', wed: 'الأربعاء', thu: 'الخميس', fri: 'الجمعة', sat: 'السبت',
    'الأرطوفونيا (تقويم النطق) - Speech Therapy': 'الأرطوفونيا (تقويم النطق)',
    'الأشعة - Radiology': 'الأشعة', 'الأمراض الجلدية - Dermatology': 'الأمراض الجلدية',
    'الأمراض الصدرية - Pulmonology': 'الأمراض الصدرية',
    'الأمراض المعدية - Infectious Disease': 'الأمراض المعدية',
    'الأنف والأذن والحنجرة - ENT (Otolaryngology)': 'الأنف والأذن والحنجرة',
    'التخدير - Anesthesiology': 'التخدير', 'التغذية العلاجية - Clinical Nutrition': 'التغذية العلاجية',
    'الجراحة التجميلية - Plastic Surgery': 'الجراحة التجميلية',
    'الجراحة العامة - General Surgery': 'الجراحة العامة',
    'الطب الباطني - Internal Medicine': 'الطب الباطني',
    'الطب المخبري (التحاليل) - Laboratory Medicine': 'الطب المخبري (التحاليل)',
    'الطب النفسي - Psychiatry': 'الطب النفسي',
    'العلاج الطبيعي وإعادة التأهيل - Physiotherapy & Rehabilitation': 'العلاج الطبيعي وإعادة التأهيل',
    'الغدد الصماء والسكري - Endocrinology': 'الغدد الصماء والسكري',
    'أمراض الجهاز الهضمي - Gastroenterology': 'أمراض الجهاز الهضمي',
    'أمراض الدم - Hematology': 'أمراض الدم',
    'أمراض الروماتيزم والمفاصل - Rheumatology': 'أمراض الروماتيزم والمفاصل',
    'أمراض القلب - Cardiology': 'أمراض القلب', 'أمراض الكلى - Nephrology': 'أمراض الكلى',
    'أمراض النساء والتوليد - Gynecology & Obstetrics': 'أمراض النساء والتوليد',
    'جراحة الأوعية الدموية - Vascular Surgery': 'جراحة الأوعية الدموية',
    'جراحة العظام - Orthopedics': 'جراحة العظام',
    'جراحة القلب والصدر - Cardiothoracic Surgery': 'جراحة القلب والصدر',
    'جراحة المخ والأعصاب - Neurosurgery': 'جراحة المخ والأعصاب',
    'جراحة المسالك البولية - Urology': 'جراحة المسالك البولية',
    'طب الأعصاب - Neurology': 'طب الأعصاب', 'طب الأسرة - Family Medicine': 'طب الأسرة',
    'طب الأسنان - Dentistry': 'طب الأسنان', 'طب الأطفال - Pediatrics': 'طب الأطفال',
    'طب الأورام - Oncology': 'طب الأورام',
    'طب الحساسية والمناعة - Allergy & Immunology': 'طب الحساسية والمناعة',
    'طب الشيخوخة - Geriatrics': 'طب الشيخوخة', 'طب الطوارئ - Emergency Medicine': 'طب الطوارئ',
    'طب العيون - Ophthalmology': 'طب العيون', 'طب عام - General Medicine': 'طب عام',
    'علم الوراثة الطبية - Medical Genetics': 'علم الوراثة الطبية',
    'أولاد سيدي الميهوب': 'أولاد سيدي الميهوب', 'أولاد يعيش': 'أولاد يعيش', 'الحاسي': 'الحاسي',
    'الحمادنة': 'الحمادنة', 'القطار': 'القطار', 'القلعة': 'القلعة', 'المطمر': 'المطمر',
    'المرجة': 'المرجة', 'الولجة': 'الولجة', 'بن داود': 'بن داود', 'بني درقون': 'بني درقون',
    'بني زنطيس': 'بني زنطيس', 'بلعسل بوزقزة': 'بلعسل بوزقزة', 'جديوية': 'جديوية',
    'حد الشكالة': 'حد الشكالة', 'حمري': 'حمري', 'دار بن عبد الله': 'دار بن عبد الله',
    'رمكة': 'رمكة', 'زمورة': 'زمورة', 'سوق الحد': 'سوق الحد',
    'سيدي امحمد بن علي': 'سيدي امحمد بن علي', 'سيدي امحمد بن عودة': 'سيدي امحمد بن عودة',
    'سيدي خطاب': 'سيدي خطاب', 'سيدي سعادة': 'سيدي سعادة', 'سيدي لزرق': 'سيدي لزرق',
    'عين الرحمة': 'عين الرحمة', 'عين طارق': 'عين طارق', 'عمي موسى': 'عمي موسى',
    'غليزان': 'غليزان', 'لحلاف': 'لحلاف', 'مازونة': 'مازونة', 'مديونة': 'مديونة',
    'منداس': 'منداس', 'وادي الجمعة': 'وادي الجمعة', 'وادي السلام': 'وادي السلام',
    'وادي رهيو': 'وادي رهيو', 'واريزان': 'واريزان', 'يلل': 'يلل',
    chatTitle: 'المستشار الطبي', chatSubtitle: 'متاح للرد الفوري',
    chatWelcome: 'أهلاً بك في دليل أطباء غليزان. أنا مساعدك الآلي🩺. كيف يمكنني مساعدتك اليوم؟',
    chatInputPlaceholder: 'اكتب سؤالك هنا...', chatToggleBtn: 'تحدث معنا',
    chatLoadingDB: 'عذراً، جاري تحميل قاعدة بيانات الأطباء حالياً.',
    chatNoResults: 'عذراً، لم أتمكن من العثور على أطباء يطابقون بحثك.',
    chatFoundPrefix: 'وجدت ', chatFoundSuffix: ' أطباء بناءً على طلبك. إليك أبرز 3 نتائج:',
    chatExactResults: 'تفضل، لقد وجدت هذه النتائج المطابقة لسؤالك:',
    chatDoctorLabel: 'الدكتور(ة): ', chatSpecLabel: 'الاختصاص: ', chatPhoneLabel: 'الهاتف: ',
    chatMunLabel: 'البلدية: ', chatAddressLabel: 'العنوان: ', chatBookDetailsBtn: 'عرض التفاصيل والحجز'
  }
};
...
@@ -311,176 +381,95 @@ async function getCurrentUser() {
  };
}
...
function updateUserUI(user) {
  ...
  if (user) {
    ...
    localStorage.setItem('medicalUser', JSON.stringify({
      UserID: user.id, Email: user.email, Name: displayName,
      Provider: user.app_metadata?.provider || 'supabase', Role: 'member'
    }));
  } else {
...
async function handleEmailAuth() {
  ...
  if (data.user) {
    ...
    if (isSignUp) {
      ...
      const { data, error } = await supabaseClient.auth.signUp({
        email, password, options: { data: { name, display_name: name }, emailRedirectTo: window.location.origin }
      });
      if (error) throw error;
      resetLoginAttempts();
      if (data.user) {
  ...
  setTimeout(() => router('user-dashboard'), 500);
    ...
    recordFailedAttempt();
    let msg = err.message;
@@ -490,70 +479,61 @@ async function handleEmailAuth() {
...
@@ -566,189 +546,23 @@ function renderDoctors(doctors) {
    ...
    actionBtn.innerHTML = isBookingEnabled ? (currentLang === 'ar' ? 'عرض التفاصيل والحجز' : 'View Details & Book') : (currentLang === 'ar' ? 'الحجوزات مغلقة حالياً' : 'Bookings Currently Closed');
...
@@ -761,7 +575,7 @@ function updateSEOMetaTags(doc) {
...
@@ -771,25 +585,21 @@ function handleSEOAndRender() {
      ...
      setTimeout(() => { openDoctorProfileModal(targetDoc, doctorName); }, 300);
...
@@ -798,56 +608,62 @@ function handleSEOAndRender() {
  populateFilters();
}
...
function openDoctorProfileModal(doc, doctorName) {
  ...
  if (doc.working_days && Object.keys(doc.working_days).length > 0) {
    try {
      ...
      for(let i=0; i<=6; i++) {
        if(wd[i] && wd[i].active) {
          scheduleHtml += `<div style="display:flex; justify-content:space-between; padding: 0.25rem 0; font-size: 0.9rem;"><span style="color: var(--text-secondary);">${daysNames[i]}</span><span dir="ltr" style="color: var(--text); font-weight: 600;">${wd[i].start} - ${wd[i].end}</span></div>`;
        }
      }
    } catch(e) { console.error('Error parsing working days:', e); }
  }
  ...
  content.innerHTML = `
    <div class="dp-header">
      ...
      <div class="avatar" style="width: 64px; height: 64px; font-size: 1.5rem; background: white; color: var(--primary); box-shadow: none;">${(doc.first_name?.[0] || '') + (doc.last_name?.[0] || '')}</div>
      <div><h2 style="margin: 0; font-size: 1.25rem; font-weight: bold;">${doctorName}</h2><div style="opacity: 0.9; font-size: 0.9rem;">${escapeHtml(t(doc.specialty))}</div></div>
    </div>
    <div class="dp-body">
      <div class="dp-info-row">
        ...
        <div><div style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 0.2rem;">${currentLang === 'ar' ? 'العنوان الدقيق' : 'Exact Location'}</div><div style="font-weight: 600; color: var(--text);">${escapeHtml(doc.exact_location)}, ${escapeHtml(t(doc.municipality))}</div></div>
      </div>
      <div class="dp-info-row">
        ...
        <div><div style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 0.2rem;">${currentLang === 'ar' ? 'رقم العيادة' : 'Clinic Phone'}</div><div style="font-weight: 600; color: var(--text);" dir="ltr">${escapeHtml(formatPhoneNumber(doc.phone))}</div></div>
      </div>
      <div class="dp-info-row">
        ...
        <div style="flex: 1;"><div style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 0.4rem;">${currentLang === 'ar' ? 'أوقات العمل المتاحة' : 'Available Working Hours'}</div><div style="background: var(--surface); padding: 0.75rem; border-radius: 8px; border: 1px solid var(--border);">${scheduleHtml}</div></div>
      </div>
      ${doc.extra_info ? `<div class="dp-info-row"><div class="dp-info-icon"><svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg></div><div><div style="font-size: 0.8rem; color: var(--text-secondary); margin-bottom: 0.2rem;">${currentLang === 'ar' ? 'معلومات إضافية' : 'Extra Information'}</div><div style="color: var(--text); font-size: 0.9rem; line-height: 1.5;">${escapeHtml(doc.extra_info)}</div></div></div>` : ''}
      <div style="display: flex; gap: 0.75rem; margin-top: 1rem;">
        <button class="btn btn-secondary" style="flex: 1; padding: 0.5rem; font-size: 0.85rem;" onclick="openReviewsModal('${doc.id}', '${escapeHtml(doc.first_name)} ${escapeHtml(doc.last_name)}')"><span style="color: #b45309; margin-inline-end: 4px;">★</span> ${currentLang === 'ar' ? 'التقييمات' : 'Reviews'}</button>
        <button class="btn btn-secondary" style="flex: 1; padding: 0.5rem; font-size: 0.85rem;" onclick="navigator.clipboard.writeText('${profileUrl}'); showToast(currentLang==='ar'?'تم النسخ':'Copied', 'success');"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" style="margin-inline-end: 4px;"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg>${shareText}</button>
      </div>
    </div>
    <div class="dp-footer">
      <button class="btn ${isBookingEnabled ? 'btn-success' : 'btn-secondary'} btn-block" ${isBookingEnabled ? `onclick="document.getElementById('doctorProfileModal').classList.add('hidden'); openBooking('${doc.id}')"` : 'disabled'}>${isBookingEnabled ? (currentLang === 'ar' ? 'تأكيد وحجز موعد' : 'Confirm & Book') : (currentLang === 'ar' ? 'الحجوزات مغلقة' : 'Bookings Closed')}</button>
    </div>`;
  modal.classList.remove('hidden');
}
...
@@ -866,7 +682,6 @@ function populateFilters() {
  filterDoctors();
}
...
@@ -881,2331 +696,754 @@ function filterDoctors() {
  ...
  const suggestionsHtml = filtered.slice(0, 5).map(doc => {
    ...
    const doctorName = escapeHtml(doc.first_name) + ' ' + escapeHtml(doc.last_name);
    const specialtyStr = escapeHtml(t(doc.specialty));
    return `<div class="suggestion-item" onclick="selectSuggestion('${doc.id}')"><div class="sugg-avatar">${avatarText}</div><div style="flex: 1; min-width: 0;"><div style="font-weight: bold; font-size: 0.95rem; color: var(--text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${currentLang === 'ar' ? 'د.' : 'Dr.'} ${doctorName}</div><div style="font-size: 0.8rem; color: var(--text-secondary); white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${specialtyStr} - ${escapeHtml(t(doc.municipality))}</div></div></div>`;
  }).join('');
...
async function handleAddDoctor(e) {
  ...
  try {
    ...
    const { data: newDoctor, error } = await supabaseClient.from('doctors').insert([{
      first_name: data.FirstName.trim(), last_name: data.LastName.trim(),
      phone: data.Phone.replace(/\s/g, ''), exact_location: data.ExactLocation.trim(),
      specialty: data.Specialty.trim(), municipality: data.Municipality.trim(),
      extra_info: data.ExtraInfo ? data.ExtraInfo.trim() : '',
      password_hash: hashedPassword, booking_enabled: false, working_days: {}, is_active: false
    }]).select().single();
    if (error) throw new Error(error.message);
...
function openBooking(doctorId) {
  ...
  if (!currentDoctor) { showToast(currentLang === 'ar' ? 'الطبيب غير موجود' : 'Doctor not found', 'error'); return; }
  ...
  // جدول العمل
  let infoHtml = `<div class="doctor-header"><div class="avatar">${(currentDoctor.first_name?.[0]||'')+(currentDoctor.last_name?.[0]||'')}</div><div><div class="font-bold text-lg">Dr. ${escapeHtml(currentDoctor.first_name)} ${escapeHtml(currentDoctor.last_name)}</div><div class="text-sm text-gray">${escapeHtml(t(currentDoctor.specialty))} • ${escapeHtml(t(currentDoctor.municipality))}</div></div></div>`;
  let scheduleHtml = '';
  let wd = {};
  if (currentDoctor.working_days) {
    try {
      ...
      wd = typeof currentDoctor.working_days === 'string' ? JSON.parse(currentDoctor.working_days) : currentDoctor.working_days;
      ...
      for(let i=0; i<=6; i++) {
        if(wd[i] && wd[i].active) {
          ...
          `;
          activeDaysHtml += `<div style="display:flex; justify-content:space-between; padding: 0.375rem 0; border-bottom: 1px dashed var(--border); font-size: 0.875rem;"><span class="font-semibold" style="color: var(--text);" data-i18n="${daysKeys[i]}">${t(daysKeys[i])}</span><span dir="ltr" style="color: var(--primary); font-weight: 600;">${wd[i].start} - ${wd[i].end}</span></div>`;
        }
      }
  ...
  if (scheduleHtml === '') {
    ...
    `;
    const st = '08:00'; const et = '16:00';
    scheduleHtml = `<div style="margin-top: 1.25rem; padding: 1rem; background: var(--bg); border-radius: var(--radius); border: 1px solid var(--border);"><h4 style="font-size: 0.95rem; font-weight: bold; color: var(--text); margin-bottom: 0.5rem;" data-i18n="fallbackTitle">${t('fallbackTitle')}</h4><div style="font-size: 0.875rem; color: var(--primary); font-weight: 600;" dir="ltr"><span data-i18n="dailyTxt">${t('dailyTxt')}</span> ${st} - ${et}</div></div>`;
  }
  ...
  if (!timeInputHidden) {
    ...
    timeInputHidden.type = 'hidden'; timeInputHidden.id = 'apptTimeInput';
    timeInputHidden.name = 'AppointmentTime'; timeInputHidden.required = true;
...
dateInput.min = today;
  ...
  dateInput.onchange = function() { handleDateSelection(this.value, wd); };
  const today = new Date().toISOString().split('T')[0];
  dateInput.min = today;
  router('booking');
}
...
async function handleDateSelection(selectedDateStr, workingDays) {
  ...
  if (!selectedDateStr) { container.innerHTML = `<div class="text-sm text-gray" style="grid-column: 1 / -1;" data-i18n="selectDateFirst">${t('selectDateFirst')}</div>`; return; }
  const selectedDate = new Date(selectedDateStr);
  if (isNaN(selectedDate.getTime())) { container.innerHTML = `<div class="text-sm text-gray" style="grid-column: 1 / -1;" data-i18n="invalidDate">${t('invalidDate')}</div>`; return; }
  const dayNum = selectedDate.getDay();
  let isWorking = true;
  let shiftStart = '08:00'; let shiftEnd = '16:00';
  ...
  try {
    const { data: bookedSlots, error } = await supabaseClient.from('appointments').select('appointment_time').eq('doctor_id', currentDoctor.id).eq('appointment_date', selectedDateStr).neq('status', 'cancelled');
    if (error) throw error;
    const bookedTimes = bookedSlots.map(s => s.appointment_time);
    const slots = generateTimeSlots(shiftStart, shiftEnd, 30);
    const availableSlots = slots.filter(slot => !bookedTimes.includes(slot));
    if (availableSlots.length === 0) { container.innerHTML = `<div class="text-sm text-gray" style="grid-column: 1 / -1;" data-i18n="noSlots">${t('noSlots')}</div>`; return; }
...
function confirmBooking() {
  ...
  if (!apptTime) { showToast(currentLang === 'ar' ? 'يرجى اختيار وقت الموعد' : 'Please select appointment time', 'error'); return; }
  ...
  if (currentDoctor.working_days) {
    ...
    try { wd = typeof currentDoctor.working_days === 'string' ? JSON.parse(currentDoctor.working_days) : currentDoctor.working_days; } catch(err) {}
  }
  ...
  const doctorName = currentDoctor ? `${currentDoctor.first_name} ${currentDoctor.last_name}` : '';
  document.getElementById('confirmDialogBody').textContent = (currentLang === 'ar' ? `المريض: ${patientName} | الطبيب: د. ${doctorName} | التاريخ: ${apptDate} ${apptTime}` : `Patient: ${patientName} | Doctor: Dr. ${doctorName} | Date: ${apptDate} at ${apptTime}`);
...
async function submitBooking() {
  ...
  try {
    ...
    const { data: booking, error } = await supabaseClient.from('appointments').insert([{
      doctor_id: data.DoctorID, patient_name: data.PatientName.trim(),
      patient_phone: data.PatientPhone.trim(), appointment_date: data.AppointmentDate,
      appointment_time: data.AppointmentTime, status: 'pending', user_id: user ? user.id : null
    }]).select().single();
    if (error) throw new Error(error.message);
...
const ticketHtml = `
  <div class="e-ticket">
    <div class="e-ticket-top">
      ...
      <h3>${currentLang === 'ar' ? 'تم تأكيد الحجز' : 'Booking Confirmed'}</h3>
...
document.getElementById('successDialog').classList.remove('hidden');
    ...
    const bId = booking.id;
    const shortId = bId.split('-')[0].substring(0, 8).toUpperCase();
    const bName = data.PatientName; const bDate = data.AppointmentDate; const bTime = data.AppointmentTime;
    const bDoctor = currentDoctor ? `${currentDoctor.first_name} ${currentDoctor.last_name}` : '';
    const ticketHtml = `
      <div class="e-ticket">
        <div class="e-ticket-top">
          <div class="success-icon"><svg width="24" height="24" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg></div>
          <h3>${currentLang === 'ar' ? 'تم تأكيد الحجز' : 'Booking Confirmed'}</h3>
          <div class="doctor-name">${currentLang === 'ar' ? 'د.' : 'Dr.'} ${escapeHtml(bDoctor)}</div>
        </div>
        <div class="e-ticket-divider"></div>
        <div class="e-ticket-bottom">
          <div class="e-ticket-info"><span class="e-ticket-label">${currentLang === 'ar' ? 'رقم الحجز' : 'Booking ID'}</span><span class="e-ticket-value booking-id">${shortId}</span></div>
          <div class="e-ticket-info"><span class="e-ticket-label">${currentLang === 'ar' ? 'المريض' : 'Patient'}</span><span class="e-ticket-value">${escapeHtml(bName)}</span></div>
          <div class="e-ticket-info"><span class="e-ticket-label">${currentLang === 'ar' ? 'التاريخ والوقت' : 'Date & Time'}</span><span class="e-ticket-value" dir="ltr">${bDate} | ${bTime}</span></div>
        </div>
        <div class="e-ticket-qr"><img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data=${bId}&color=667eea" alt="QR Code" /></div>
        <div class="e-ticket-footer">${currentLang === 'ar' ? 'يرجى إبراز هذه التذكرة عند الوصول' : 'Please show this ticket upon arrival'}</div>
      </div>`;
    document.getElementById('eTicketContainer').innerHTML = ticketHtml;
    document.getElementById('successDialog').classList.remove('hidden');
  } catch (err) { showToast(t('toastBookingError') + err.message, 'error'); } finally { setLoading(btn, false); }
}
...
window.closeSuccessDialog = function() { document.getElementById('successDialog').classList.add('hidden'); router('home'); };
...
async function handleDashboardLogin(e) {
  ...
  try {
    ...
    const { data: doctor, error } = await supabaseClient.from('doctors').select('*').eq('phone', phone).eq('password_hash', hashHex).single();
    if (error || !doctor) throw new Error(currentLang === 'ar' ? 'رقم الهاتف أو كلمة المرور غير صحيحة' : 'Invalid phone or password');
    if (!doctor.is_active) throw new Error(currentLang === 'ar' ? 'حسابك غير مفعّل بعد. يرجى التواصل مع الإدارة.' : 'Your account is not active yet. Please contact admin.');
    resetLoginAttempts();
    ...
    localStorage.setItem('doctorSession', JSON.stringify({ doctorId: doctor.id, phone: phone, doctorName: `${doctor.first_name} ${doctor.last_name}` }));
  ...
  } catch (err) { recordFailedAttempt(); showToast(t('toastLoginError') + err.message, 'error'); } finally { setLoading(btn, false); }
}
...
async function fillDashboardData(doctor) {
  ...
  // ✅ ملء أوقات العمل
  document.getElementById('dashboardSubtitle').textContent = currentLang === 'ar' ? `د. ${doctor.first_name} ${doctor.last_name}` : `Dr. ${doctor.first_name} ${doctor.last_name}`;
  let savedDays = {};
  try { 
  ...
  try { savedDays = typeof doctor.working_days === 'string' ? JSON.parse(doctor.working_days) : (doctor.working_days || {}); } catch(e) {}
  const daysNames = currentLang === 'ar' ? ['الأحد', 'الإثنين', 'الثلاثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت'] : ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
  const container = document.getElementById('daysListContainer');
  container.innerHTML = '';
  for (let i = 0; i <= 6; i++) {
    ...
    `;
    row.innerHTML = `<div style="flex: 1; min-width: 100px; display: flex; align-items: center; gap: 0.5rem;"><input type="checkbox" id="day_active_${i}" ${dayData.active ? 'checked' : ''} style="width: 18px; height: 18px; cursor: pointer;"><label for="day_active_${i}" style="margin: 0; cursor: pointer; font-weight: bold;">${daysNames[i]}</label></div><div style="display: flex; gap: 0.5rem; align-items: center;"><input type="time" id="day_start_${i}" value="${dayData.start}" style="padding: 0.4rem; max-width: 110px;"><span>-</span><input type="time" id="day_end_${i}" value="${dayData.end}" style="padding: 0.4rem; max-width: 110px;"></div>`;
    container.appendChild(row);
  }
...
async function loadDoctorAppointments(doctorId) {
  ...
  empty.classList.add('hidden');
  try {
    const { data: appointments, error } = await supabaseClient.from('appointments').select('*').eq('doctor_id', doctorId).order('appointment_date', { ascending: true });
    if (error) throw error;
    if (!appointments || appointments.length === 0) { container.innerHTML = ''; empty.classList.remove('hidden'); return; }
    const confirmTxt = currentLang === 'ar' ? 'تأكيد' : 'Confirm';
    const cancelTxt = currentLang === 'ar' ? 'إلغاء' : 'Cancel';
    container.innerHTML = appointments.map(a => {
      ...
      let statusIndicator = '#f59e0b';
      if (a.status === 'confirmed') { statusStyle = 'background: #ecfdf5; color: #10b981;'; statusIndicator = '#10b981'; displayStatus = currentLang === 'ar' ? 'مؤكد' : 'Confirmed'; }
      else if (a.status === 'cancelled') { statusStyle = 'background: #fef2f2; color: #ef4444;'; statusIndicator = '#ef4444'; displayStatus = currentLang === 'ar' ? 'ملغى' : 'Cancelled'; }
      else { displayStatus = currentLang === 'ar' ? 'قيد الانتظار' : 'Pending'; }
      const actionsHtml = (a.status === 'pending') ? `<button class="btn" style="padding: 0.4rem 0.8rem; font-size: 0.85rem; background: #ecfdf5; border: 1px solid #10b981; color: #10b981; border-radius: 6px;" onclick="changeBookingStatus('${a.id}', 'confirmed')">${confirmTxt}</button><button class="btn" style="padding: 0.4rem 0.8rem; font-size: 0.85rem; background: #fef2f2; border: 1px solid #ef4444; color: #ef4444; border-radius: 6px;" onclick="changeBookingStatus('${a.id}', 'cancelled')">${cancelTxt}</button>` : `<span class="badge" style="${statusStyle}">${displayStatus}</span>`;
      return `<div class="card-hover" style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius); padding: 1.25rem; position: relative; overflow: hidden; box-shadow: var(--shadow-sm); margin-bottom: 1rem;"><div style="position: absolute; right: 0; top: 0; bottom: 0; width: 4px; background: ${statusIndicator};"></div><div style="padding-right: 0.5rem;"><div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;"><span style="font-family: monospace; font-size: 0.85rem; color: var(--text-secondary); background: var(--bg); padding: 0.25rem 0.5rem; border-radius: 6px; border: 1px solid var(--border);">${a.id.substring(0, 8).toUpperCase()}</span><span class="badge" style="${statusStyle}">${displayStatus}</span></div><h4 style="font-size: 1.15rem; font-weight: bold; color: var(--text); margin-bottom: 0.25rem;">${escapeHtml(a.patient_name)}</h4><div style="display: flex; align-items: center; gap: 0.4rem; color: var(--primary); font-size: 0.95rem; font-weight: 600; direction: ltr; margin-bottom: 1rem;"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>${escapeHtml(formatPhoneNumber(a.patient_phone))}</div><div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 1rem; border-top: 1px dashed var(--border); padding-top: 0.75rem;"><div style="display: flex; align-items: center; gap: 1rem; font-size: 0.9rem;"><div style="display: flex; align-items: center; gap: 0.4rem; color: var(--text-secondary);"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect></svg><span dir="ltr">${escapeHtml(a.appointment_date)}</span></div><div style="display: flex; align-items: center; gap: 0.4rem; color: var(--text-secondary);"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle></svg><span dir="ltr">${escapeHtml(a.appointment_time)}</span></div></div><div style="display: flex; gap: 0.5rem;">${actionsHtml}</div></div></div></div></div>`;
    }).join('');
  } catch (err) { container.innerHTML = '<div style="text-align:center; color: var(--danger); padding: 1rem;">خطأ في التحميل</div>'; }
}
...
window.changeBookingStatus = async function(bookingId, newStatus) {
  ...
  const statusText = newStatus === 'confirmed' ? (currentLang === 'ar' ? 'مؤكد' : 'Confirmed') : (currentLang === 'ar' ? 'ملغى' : 'Cancelled');
  ...
  try {
    ...
    const { error } = await supabaseClient.from('appointments').update({ status: newStatus }).eq('id', bookingId).eq('doctor_id', session.doctorId);
    if (error) throw error;
...
window.saveWorkingHours = async function() {
  ...
  try {
    ...
    const { error } = await supabaseClient.from('doctors').update({ working_days: workingDaysData }).eq('id', session.doctorId);
    if (error) throw error;
    if (data.success) {
...
window.toggleWorkingHours = function() {
    ...
    if (docIndex > -1) allDoctors[docIndex].working_days = workingDaysData;
  } catch (err) { showToast('خطأ: ' + err.message, 'error'); } finally { setLoading(btn, false, 'حفظ الأوقات'); }
};
...
async function handleToggleBooking(e) {
  ...
  try {
    ...
    const { error } = await supabaseClient.from('doctors').update({ booking_enabled: isChecked }).eq('id', session.doctorId);
    if (error) throw error;
    ...
    if (docIndex > -1) allDoctors[docIndex].booking_enabled = isChecked;
  } catch (err) { e.target.checked = !isChecked; showToast(t('toastToggleError') + ': ' + err.message, 'error'); } finally { toggleSwitch.disabled = false; }
}
    // ========================================================================
...
function updateToggleText(isEnabled) {
  ...
  if (textEl) textEl.textContent = isEnabled ? t('disableBooking') : t('enableBooking');
}
...
async function loadUserBookings() {
  ...
  try {
    ...
    bookings.forEach(b => {
      ...
      `;
      html += `<div class="card-hover" style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius); padding: 1.25rem; position: relative; overflow: hidden; box-shadow: var(--shadow-sm);"><div style="position: absolute; right: 0; top: 0; bottom: 0; width: 4px; background: ${statusIndicator};"></div><div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 1rem; padding-right: 0.5rem;"><div style="flex: 1; min-width: 250px;"><div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;"><span style="font-family: 'Courier New', monospace; font-size: 0.85rem; color: var(--primary); background: var(--bg); padding: 0.35rem 0.75rem; border-radius: 6px; border: 1px solid var(--border); letter-spacing: 1px; font-weight: bold;">${shortId}</span><span class="badge" style="${statusStyle}">${displayStatus}</span></div><h4 style="font-size: 1.15rem; font-weight: bold; color: var(--text); margin-bottom: 0.25rem;">${currentLang === 'ar' ? 'د.' : 'Dr.'} ${doctorName}</h4><p style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 1rem;">${t('patientLabel')}<span style="color: var(--text); font-weight: 500;">${b.patient_name}</span></p><div style="display: flex; align-items: center; gap: 1.5rem; font-size: 0.9rem; border-top: 1px dashed var(--border); padding-top: 0.75rem;"><div style="display: flex; align-items: center; gap: 0.4rem; color: var(--text-secondary);"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg><span dir="ltr" style="font-weight: 600;">${b.appointment_date}</span></div><div style="display: flex; align-items: center; gap: 0.4rem; color: var(--text-secondary);"><svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg><span dir="ltr" style="font-weight: 600;">${b.appointment_time}</span></div></div></div></div></div>`;
    });
    html += '</div>';
...
async function trackBooking(bookingId, phoneStr) {
  const { data, error } = await supabaseClient.from('appointments').select(`id, patient_name, appointment_date, appointment_time, status, doctors (first_name, last_name)`).eq('id', bookingId).eq('patient_phone', phoneStr).single();
...
document.querySelectorAll('#starRatingInput .star').forEach(star => {
  star.addEventListener('mouseover', function() {
    let val = parseInt(this.getAttribute('data-val'));
    document.querySelectorAll('#starRatingInput .star').forEach(s => { s.style.color = parseInt(s.getAttribute('data-val')) <= val ? '#f59e0b' : 'var(--border)'; });
  });
  star.addEventListener('mouseout', function() {
    document.querySelectorAll('#starRatingInput .star').forEach(s => { s.style.color = parseInt(s.getAttribute('data-val')) <= currentReviewRating ? '#f59e0b' : 'var(--border)'; });
  });
  star.addEventListener('click', function() {
    currentReviewRating = parseInt(this.getAttribute('data-val'));
    document.getElementById('ratingValue').value = currentReviewRating;
...
window.openReviewsModal = async function(doctorId, doctorName) {
  ...
  document.getElementById('reviewsModal').classList.remove('hidden');
  const user = await getCurrentUser();
  if (user) { document.getElementById('addReviewSection').classList.remove('hidden'); document.getElementById('loginToReviewMsg').classList.add('hidden'); }
  else { document.getElementById('addReviewSection').classList.add('hidden'); document.getElementById('loginToReviewMsg').classList.remove('hidden'); }
  loadReviews(doctorId);
};
...
async function loadReviews(doctorId) {
  ...
  try {
    ...
    const { data: reviews, error } = await supabaseClient.from('reviews').select('*').eq('doctor_id', doctorId).eq('status', 'approved').order('created_at', { ascending: false });
    if (error) throw error;
    ...
    if (!reviews || reviews.length === 0) { list.innerHTML = `<div class='p-4 text-center text-gray text-sm'>${currentLang === 'ar' ? 'لا توجد تقييمات بعد. كن أول من يقيّم!' : 'No reviews yet. Be the first to review!'}</div>`; return; }
    list.innerHTML = reviews.map(r => `
      <div class="review-item" id="review-${r.id}">
        ...
        <div class="review-header"><div><span class="review-author">${escapeHtml(r.patient_name || 'مستخدم')}</span><span class="review-date" dir="ltr" style="margin: 0 0.5rem;">${new Date(r.created_at).toLocaleDateString(currentLang === 'ar' ? 'ar-DZ' : 'en-US')}</span></div>${currentUser && r.user_id === currentUser.UserID ? `<button onclick="deleteReview('${r.id}', '${doctorId}')" style="background:transparent; border:none; color:var(--danger); cursor:pointer; font-size:0.85rem; display:flex; align-items:center; gap:0.2rem;"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M19 6v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6m3 0V4a2 2 0 012-2h4a2 2 0 012 2v2"></path></svg>${currentLang === 'ar' ? 'حذف' : 'Delete'}</button>` : ''}</div>
        <div class="star-display">${'★'.repeat(r.rating)}<span style="color:var(--border)">${'★'.repeat(5 - r.rating)}</span></div>
  ...
  } catch (err) { list.innerHTML = `<div class='p-4 text-center text-danger text-sm'>${currentLang === 'ar' ? 'خطأ في جلب التقييمات' : 'Error loading reviews'}</div>`; }
}
...
document.addEventListener('submit', async function(e) {
  if (e.target && e.target.id === 'reviewForm') {
    ...
    if (!rating || rating === "0") { showToast(currentLang === 'ar' ? 'الرجاء اختيار التقييم بالنجوم' : 'Please select a star rating', 'error'); return; }
    if (!comment.trim()) { showToast(currentLang === 'ar' ? 'الرجاء كتابة تجربتك' : 'Please write your review', 'error'); return; }
    setLoading(btn, true);
    ...
    try {
      ...
      if (!user) { showToast(currentLang === 'ar' ? 'يجب تسجيل الدخول أولاً' : 'Please login first', 'error'); setLoading(btn, false); return; }
      const { data, error } = await supabaseClient.from('reviews').insert([{ doctor_id: doctorId, user_id: user.UserID, patient_name: user.Name || user.Email.split('@')[0], rating: parseInt(rating), comment: comment.trim(), status: 'approved' }]).select().single();
      if (error) { if (error.code === '23505') showToast(currentLang === 'ar' ? 'لقد قمت بتقييم هذا الطبيب مسبقاً!' : 'You have already reviewed this doctor!', 'error'); else throw error; }
      else {
        showToast(currentLang === 'ar' ? 'تم إضافة تقييمك بنجاح' : 'Review added successfully', 'success');
        e.target.reset();
        currentReviewRating = 0;
        e.target.reset(); currentReviewRating = 0;
    ...
    } catch (err) { showToast(currentLang === 'ar' ? 'خطأ: ' + err.message : 'Error: ' + err.message, 'error'); } finally { setLoading(btn, false, currentLang === 'ar' ? 'نشر التقييم' : 'Submit Review'); }
  }
});
    // ========================================================================
...
const normalizeText = (text) => {
  if (!text) return "";
  return text.trim().toLowerCase().replace(/[أإآ]/g, 'ا').replace(/ة/g, 'ه').replace(/[ًٌٍَُِّْ]/g, '').replace(/[^a-z0-9ا-ي\s]/g, '');
};
...
const processUserMessage = (rawMsg) => {
  ...
  if (!allDoctors || allDoctors.length === 0) return t('chatLoadingDB');
  const isAskingForPhone = currentLang === 'ar' ? /رقم|هاتف|تلفون|موبيل|اتصال/i.test(cleanMsg) : /phone|number|contact|call/i.test(cleanMsg);
  const isAskingForLocation = currentLang === 'ar' ? /عنوان|اين|مكان|موقع|وين/i.test(cleanMsg) : /address|location|where|place/i.test(cleanMsg);
  let matchedDoctors = [];
  ...
  let detectedSpecialty = null; let detectedMunicipality = null;
  availableSpecialties.forEach(spec => { if (cleanMsg.includes(normalizeText(t(spec)))) detectedSpecialty = spec; });
  availableMunicipalities.forEach(mun => { if (cleanMsg.includes(normalizeText(t(mun)))) detectedMunicipality = mun; });
  matchedDoctors = allDoctors.filter(doc => {
    const docNameAr = normalizeText(doc.first_name + " " + doc.last_name);
    const isNameMatch = cleanMsg.split(' ').some(word => word.length > 2 && docNameAr.includes(word));
  ...
  if (matchedDoctors.length === 0) return t('chatNoResults');
  if (matchedDoctors.length > 3) return `${t('chatFoundPrefix')} ${matchedDoctors.length} ${t('chatFoundSuffix')}` + generateCardsHtml(matchedDoctors.slice(0, 3), isAskingForPhone, isAskingForLocation);
...
const generateCardsHtml = (doctorsList, focusPhone, focusLocation) => {
  return doctorsList.map(doc => {
    ...
    if (focusPhone || (!focusPhone && !focusLocation)) infoHtml += `<div><strong>${t('chatPhoneLabel')}</strong> <span dir="ltr" style="display: inline-block; direction: ltr;">${escapeHtml(formatPhoneNumber(doc.phone))}</span></div>`;
    if (focusLocation || (!focusPhone && !focusLocation)) { infoHtml += `<div><strong>${t('chatMunLabel')}</strong> ${escapeHtml(t(doc.municipality))}</div>`; infoHtml += `<div><strong>${t('chatAddressLabel')}</strong> ${escapeHtml(doc.exact_location)}</div>`; }
    infoHtml += `<button onclick="document.getElementById('medicalChatbot').classList.add('hidden'); openDoctorProfileModal(allDoctors.find(d => d.id === '${doc.id}'), '${docPrefix} ${escapeHtml(doc.first_name)} ${escapeHtml(doc.last_name)}')" style="margin-top: 8px; background: var(--primary-light); color: var(--primary-dark); border: none; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-family: inherit; font-size: 0.85rem; font-weight: bold; width: 100%; transition: opacity 0.2s;">${t('chatBookDetailsBtn')}</button></div>`;
    return infoHtml;
  }).join('');
};
...
function router(viewName, pushHistory = true) {
  if (viewName === 'add-doctor') { getCurrentUser().then(user => { if (!user) { showToast(t('loginRequired'), 'error'); router('login'); } }); }
  document.querySelectorAll('.view').forEach(el => el.classList.add('hidden'));
  const target = document.getElementById('view-' + viewName);
  if (target) target.classList.remove('hidden');
  document.querySelectorAll('.nav-btn').forEach(btn => btn.classList.remove('active'));
  ...
  if (viewName === 'user-dashboard') loadUserBookings();
  const pill = document.getElementById('userPill');
  if (viewName === 'dashboard') { if(pill) pill.classList.add('hidden'); } else { updateUserUI(); }
}
...
function setLang(lang) {
  ...
  updateAuthToggle();
  updateUserUI();
  if (allDoctors.length > 0) { populateFilters(); renderDoctors(allDoctors); }
  setTimeout(() => {
    if (window.tsAddSpecialty && addSpecSel) { const val = window.tsAddSpecialty.getValue(); window.tsAddSpecialty.clearOptions(); Array.from(addSpecSel.options).forEach(opt => window.tsAddSpecialty.addOption({value: opt.value, text: opt.text})); if(val) window.tsAddSpecialty.setValue(val); }
    if (window.tsAddMunicipality && addMunSel) { const val = window.tsAddMunicipality.getValue(); window.tsAddMunicipality.clearOptions(); Array.from(addMunSel.options).forEach(opt => window.tsAddMunicipality.addOption({value: opt.value, text: opt.text})); if(val) window.tsAddMunicipality.setValue(val); }
  }, 50);
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('backToHomeBtn').onclick = () => router('home');
  document.getElementById('backToDirBtn').onclick = () => router('home');
  const tsSettings = { create: false, sortField: { field: "text", direction: "asc" }, render: { no_results: function(data, escape) { return '<div class="no-results">' + (currentLang === 'ar' ? 'لا توجد نتائج' : 'No results found') + '</div>'; } } };
  window.tsSpecialtyFilter = new TomSelect("#specialtyFilter", tsSettings);
  window.tsMunicipalityFilter = new TomSelect("#municipalityFilter", tsSettings);
  window.tsAddSpecialty = new TomSelect('select[name="Specialty"]', tsSettings);
  window.tsAddMunicipality = new TomSelect('select[name="Municipality"]', tsSettings);
  ...
  if (trackForm) {
    trackForm.addEventListener('submit', async (e) => {
      ...
      resultDiv.classList.add('hidden');
      try {
        const data = await trackBooking(bookingId, phoneStr);
        if (data) {
          let statusStyle = 'background: #f1f5f9; color: #64748b;';
          if (data.status === 'confirmed') statusStyle = 'background: #ecfdf5; color: #10b981;';
          if (data.status === 'cancelled') statusStyle = 'background: #fef2f2; color: #ef4444;';
          let displayStatus = data.status;
          if (currentLang === 'en') { if (data.status === 'confirmed') displayStatus = 'Confirmed'; else if (data.status === 'cancelled') displayStatus = 'Cancelled'; else displayStatus = 'Pending'; }
          else { if (data.status === 'confirmed') displayStatus = 'مؤكد'; else if (data.status === 'cancelled') displayStatus = 'ملغى'; else displayStatus = 'قيد الانتظار'; }
          const doctorName = data.doctors ? `${data.doctors.first_name} ${data.doctors.last_name}` : 'طبيب';
          const detailsTxt = currentLang === 'ar' ? 'تفاصيل الحجز:' : 'Booking Details:';
          const idTxt = currentLang === 'ar' ? 'رقم الحجز:' : 'Booking ID:';
          const nameTxt = currentLang === 'ar' ? 'الطبيب:' : 'Doctor:';
          const patientTxt = currentLang === 'ar' ? 'المريض:' : 'Patient:';
          const dateTimeTxt = currentLang === 'ar' ? 'التاريخ والوقت:' : 'Date & Time:';
          const currentStatusTxt = currentLang === 'ar' ? 'الحالة الحالية:' : 'Current Status:';
          resultDiv.innerHTML = `<h4 class="font-bold mb-2">${detailsTxt}</h4><div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;"><span>${idTxt}</span> <strong>${data.id.substring(0, 8).toUpperCase()}</strong></div><div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;"><span>${nameTxt}</span> <strong>${currentLang === 'ar' ? 'د.' : 'Dr.'} ${escapeHtml(doctorName)}</strong></div><div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;"><span>${patientTxt}</span> <strong>${escapeHtml(data.patient_name)}</strong></div><div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;"><span>${dateTimeTxt}</span> <strong dir="ltr">${escapeHtml(data.appointment_date)} ${escapeHtml(data.appointment_time)}</strong></div><div style="display:flex; justify-content:space-between; align-items:center; margin-top:1rem; border-top:1px solid var(--border); padding-top:1rem;"><span>${currentStatusTxt}</span> <span class="badge" style="${statusStyle}">${escapeHtml(displayStatus)}</span></div>`;
          resultDiv.classList.remove('hidden');
        } else { showToast(currentLang === 'ar' ? 'بيانات الحجز غير صحيحة' : 'Booking not found', 'error'); }
      } catch (err) { showToast(currentLang === 'ar' ? 'خطأ في الاتصال' : 'Connection Error', 'error'); } finally { setLoading(btn, false, currentLang === 'ar' ? 'بحث عن الحجز' : 'Search Booking'); }
    });
  }
  ...
  if (savedSession) {
    try {
      ...
      if (session.doctorId) {
        const { data: doctor } = await supabaseClient.from('doctors').select('is_active, working_days, booking_enabled, first_name, last_name').eq('id', session.doctorId).single();
        if (doctor && doctor.is_active) {
          document.getElementById('loginSection').classList.add('hidden');
          document.getElementById('dashboardSection').classList.remove('hidden');
          const fullDoctor = { ...doctor, first_name: doctor.first_name || session.doctorName?.split(' ')[0], last_name: doctor.last_name || session.doctorName?.split(' ')[1] };
...
async function loadDoctorAppointments(doctorId) {
  ...
  const chatInputText = document.getElementById('chatInputText');
  const chatMessages = document.getElementById('chatMessages');
  const toggleChat = () => { medicalChatbot.classList.toggle('hidden'); if (!medicalChatbot.classList.contains('hidden')) chatInputText.focus(); };
  chatbotToggleBtn.addEventListener('click', toggleChat);
  closeChatBtn.addEventListener('click', toggleChat);
  const appendMessage = (sender, htmlContent) => { const msgDiv = document.createElement('div'); msgDiv.className = `chat-msg ${sender === 'user' ? 'user-msg' : 'bot-msg'}`; msgDiv.innerHTML = htmlContent; chatMessages.appendChild(msgDiv); chatMessages.scrollTop = chatMessages.scrollHeight; };
  const handleSend = () => { const text = chatInputText.value.trim(); if (!text) return; appendMessage('user', escapeHtml(text)); chatInputText.value = ''; const typingId = "typing-" + Date.now(); const typingHtml = `<div id="${typingId}" class="typing-indicator"><div class="typing-dot"></div><div class="typing-dot"></div><div class="typing-dot"></div></div>`; appendMessage('bot', typingHtml); setTimeout(() => { const typingIndicator = document.getElementById(typingId); if (typingIndicator) typingIndicator.parentElement.remove(); const botResponse = processUserMessage(text); appendMessage('bot', botResponse); }, 800); };
  sendChatBtn.addEventListener('click', handleSend);
  chatInputText.addEventListener('keypress', (e) => { if (e.key === 'Enter') handleSend(); });
});
